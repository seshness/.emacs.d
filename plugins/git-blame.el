...
(defvar git-blame-log-message-format "oneline"
  "*the string given to git log --pretty=... to generate log messages")
...
(defun git-describe-commit (hash)
  (with-temp-buffer
    (call-process "git" nil t nil
                  "log" "-1" (concat "--pretty=" git-blame-log-message-format)
                  hash)
